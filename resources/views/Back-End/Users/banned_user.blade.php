                                        ...
                                        @foreach ($banned_users as $banned)
                                            <tr style="text-align: center;">
                                                ...
                                                <td style="width: 50px; !important"> <img class="profile-user-img img-fluid"
                                                        src="{{ asset('admin-style/admin-images/' . $banned->avatar) }}"
                                                        alt="User picture">
                                                </td>
                                                <td>{{ $banned->name }}</td>
                                                <td> {{ $banned->email }}</td>
                                                <td>{{ $banned->postion }}</td>
                                                <td>
                                                    <a href="{{ url('users/Edit/' . $banned->id) }}"><button type="button"
                                                            style="width: 45%" class="btn btn-outline-primary btn-md"><i
                                                                class="fa fa-pencil" aria-hidden="true"></i>
                                                            Unban</button></a>
                                                    <a href="javascript:"><button rel="{{ $banned->id }}" rel1="user"

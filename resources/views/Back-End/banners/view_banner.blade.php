                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">DataTable To View Banners</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody style="line-height: 4 !important;">
                                        @foreach ($View_banners as $banner)
                                            <tr style="text-align: center;">
                                                <td>{{ $banner->id }}</td>
                                                <td style="width: 50px; !important"> <img class="border-none profile-user-img img-fluid"
                                                        src="{{ asset('front-images/banners/' . $banner->images) }}"
                                                        alt="User picture">
                                                </td>
                                                <td>{{ $banner->Title }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                    <span  style="color:red">DiaActive</span>
                                                @endif
                                            </td>
                                                <td>
                                                    <a href="{{ url('banner/Edit/' . $banner->id) }}"><button type="button"
                                                            style="width: 45%" class="btn btn-outline-primary btn-md"><i
                                                                class="fa fa-pencil" aria-hidden="true"></i>
                                                            Modify</button></a>
                                                    <a href="javascript:"><button rel="{{ $banner->id }}" rel1="banner"

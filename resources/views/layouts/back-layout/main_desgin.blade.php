...
<head>
    ...
    <title>Abo-shop | Dashboard</title>
    ...
    <!-- pace line -->
    <link rel="stylesheet" href="{{ url('admin-style/plugins/pace-progress/themes/black/pace-theme-flat-top.css') }}">
    <!-- Toastr -->
...
<body class="hold-transition sidebar-mini layout-fixed pace-primary">
    ...
    <script src="{{ url('admin-style/plugins/toastr/extra_toastr.js') }}"></script>
      <!-- pace-progress -->
<script src="{{ url('admin-style/plugins/pace-progress/pace.min.js') }}"></script>

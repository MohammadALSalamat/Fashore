...
<body>
    ...
    <div id="loginbox">
        <form id="loginform" class="form-vertical" action="{{ route('register_page') }}" method="POST">
            @csrf
            <div class="text-center control-group normal_text">
                <h3 style="color: silver; font-size: 50px">
                    <strong style="color: rgb(38, 104, 38)">Register</strong>Panel
                </h3>
            </div>
                ...
                <div class="controls">
                    <div class="main_input_box1">
                        <span class="add-on bg_lg"><i class="icon-user"></i></span><input type="text" name="username"
                            placeholder="Enter Your Name" autocomplete="off" class="login" required
                            style="padding: 25px;" />
                    </div>
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
                    <div class="main_input_box2">
                        <span class="add-on bg_ly" style="margin-right: 5%"><i class="icon-envelope"></i></span><input
                            type="email" name="email" placeholder="Enter Your Email" class="pass" autocomplete="off"
                            required style="padding: 25px;" />
                    </div>
                </div>
            </div>
            <div class="control-group">
            ...
            <p class="px-5 font-semibold text-white"> Do You have Account ? <a href="{{ route('Login_page') }}"
